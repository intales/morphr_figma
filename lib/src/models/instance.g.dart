...
abstract class _$InstanceCWProxy {
  ...
  Instance layoutWrap(LayoutWrap layoutWrap);
...
class _$InstanceCWProxyImpl implements _$InstanceCWProxy {
  ...
  @override
  Instance layoutWrap(LayoutWrap layoutWrap) => this(layoutWrap: layoutWrap);
  ...
  Instance call({
    ...
    return Instance(
      ...
      componentProperties: componentProperties == const $CopyWithPlaceholder()
